...
import es.upm.oeg.epnoi.matching.metrics.model.space.RepresentationalSpace
...
//    val start = System.currentTimeMillis
    //
    //    // Update resources from corpus
    //    val corpus = new RepresentationalSpace(Articles.corpus,new InMemoryResourceRepository(Articles.corpus))
    //
